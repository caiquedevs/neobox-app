...
export const BtnUpload = (props: Props) => {
  ...
  return (
    <>
      <ShowIf show={loading} className="w-16 h-16 absolute bottom-20 right-5">
        <View className="w-full h-full rounded-xl items-center justify-center bg-zinc-300 overflow-hidden">
          <Text>
      ...
      <ShowIf
        show={!loading && network.ready && network.connection && cart && cart.length}
